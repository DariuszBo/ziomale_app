...
st.set_page_config(page_title="Ziomale 🧑")
...
with st.sidebar:
    ...
    st.sidebar.markdown("## 👤 Twój profil")
    age = st.selectbox("🎂 Wiek", ['<18', '25-34', '45-54', '35-44', '18-24', '>=65', '55-64', 'unknown'], 
                       help="Wybierz dane najbardziej pasujące do Ciebie"
                       )
